...
H = tf.keras.layers.Dense(10, activations = "swish")(X)
#최근에 발표된 성능이 좋은 활성화 함수이다.
H = tf.keras.layers.Dense(5, activations = "swish")(H)
H = tf.keras.layers.Dense(3, activations = "swish")(H)
